...
NON_CANCER = [0, 1, 3, 4, 5, 6]
CANCER = [7, 8]


def main() -> None:
    recalls = np.asarray(
        [0.90, 0.80, 0.00, 0.70, 0.60, 0.50, 0.40, 0.20, 0.30]
    )
    f1 = np.asarray(
        [0.91, 0.81, 0.00, 0.71, 0.61, 0.51, 0.41, 0.25, 0.35]
    )
    ...
    print("PASS: story metric groups exclude label 2")
